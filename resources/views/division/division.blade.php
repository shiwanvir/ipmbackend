        ...
        <div class="col-md-12">
            <div class="panel panel-flat">
                <div class="panel-heading">
                    <h6 class="panel-title">Add Division</h6>
                        ...
                        <div class="tab-content">
                            <div class="tab-pane active" id="highlighted-justified-tab1">
                                <div class="col-md-12">
                                    ...
                                    <table class="table datatable-basic" id="division_tbl">
                                        <thead>
                                            <tr>
                                        ...
                                        <div class="modal-content">
                                            <form class="form-horizontal form-validate-jquery" action="#" id="division_form">
                                                ...
                                                <div class="modal-body">
                                                    {{csrf_field()}}
                                                    <input type="hidden" value="0" name="division_hid" id="division_hid" class="form-control input-xxs">
...
<script type="text/javascript" src="js/division/division.js"></script>
